    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">系统运行状态</a>
            </div>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a target="_blank" href="https://www.ubuntu.com/">ubuntu</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">About <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a target="_blank" href="https://github.com/Hasiy/dashboard">GitHub Source</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div style="background-color: #E0E0E0; padding: 5px; border-radius: 3px;">
                    <div class="text-center" style="margin:20px; padding: 10px 0 10px 0; background-color:#CEFCA3; border-radius: 3px;"><div class="label">主机IP地址</div><div id="hostip" style="font-size: 150%; font-weight: bolder;"><?php echo($D['hostip']); ?></div></div>
                    ...
                    <div class="text-center" style="margin:20px; padding: 10px 0 10px 0; background-color:#FFFECD; border-radius: 3px;"><div class="label">正常运行时间</div><div id="uptime" style="font-size: 120%; font-weight: bolder;">0</div></div>
                    ...
                    <div class="text-center" style="margin:20px; padding: 10px 0 10px 0; background-color:#FAFAFA; border-radius: 3px;"><div class="label">主机名字</div><div id="hostname" style="font-size: 110%; font-weight: bolder;"><?php echo($D['hostname']); ?></div></div>
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div style="height: 200px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #CDFD9F;"><strong><small>CPU/中央处理器</small></strong></div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div style="height: 200px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #CDFD9F;"><strong><small>MEMORY/内存</small></strong></div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        ...
                        <div style="height: 90px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #CEFFFF;"><strong><small>CACHE/缓存</small></strong></div>
                                <div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0;">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        ...
                        <div style="height: 90px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #CDFD9F;"><strong><small>REAL MEMORY/物理内存</small></strong></div>
                                <div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0;">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        ...
                        <div style="height: 90px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #CCCDFC;"><strong><small>SWAP/交换空间</small></strong></div>
                                <div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0;">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        ...
                        <div style="height: 90px;">
                            <div class="row" style="margin: 0; background-color:#E0E0E0;">
                                <div class="text-center" style="padding: 2px 0 2px 0; background-color: #9BCEFD;"><strong><small>DISK/磁盘</small></strong></div>
                                <div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="footer">
                    ...
                    <p class="pull-left" style="font-size: 12px;">Powered by <a target="_blank" href="https://github.com/Hasiy/dashboard"><strong>系统运行状态</strong></a> v<?php echo($D['version']) ?>, <a target="_blank" href="http://www.hasiymagicmirror.top">hasiymagicmirror.top</a> all rights reserved.
                    </p>
                </div>
            </div>
        </div>
